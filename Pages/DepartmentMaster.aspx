    ...
    <div id="content">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DepartmentCode" HeaderText="DepartmentCode" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                            <asp:BoundField DataField="DepartmentName" HeaderText="Department Name" />
                                            <asp:BoundField DataField="DepartmentRemarks" HeaderText="Department Remarks" />
                                            <asp:BoundField DataField="DepartmentTypeName" HeaderText="Department Type Name" />
                ...
                <div id="maindialog" class="modal modal-md" style="overflow-y: auto;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Department Remarks</label>
                                            <asp:TextBox ID="txtDepartmentRemarks" runat="server" placeholder="Enter Department Remarks" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Department Type</label>
                                            <asp:DropDownList ID="ddlDepartmentType" runat="server" AppendDataBoundItems="true" CssClass="chosen form-control">
                                                <asp:ListItem Value="0" Selected="True">Select Department Type</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
