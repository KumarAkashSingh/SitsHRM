<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DistrictMaster.aspx.cs" Inherits="DistrictMaster" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="districtid" HeaderText="districtid" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-horizontal form-group">
                                            ...
                                            <div class="col-md-12">
                                                <asp:DropDownList CssClass="form-control chosen" ID="ddlState" runat="server" AppendDataBoundItems="true">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDistrictName" runat="server" placeholder="Enter District Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
