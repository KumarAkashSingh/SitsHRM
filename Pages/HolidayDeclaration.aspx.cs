...
public partial class Pages_HolidayDeclaration : System.Web.UI.Page
{
    ...
    {
        cmd = new SqlCommand("SP_HolidayDeclaration", conn);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (txtInTime.Text == "")
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Please select In Time');ShowPopup3();", true);
            return;
        }
        if (txtOutTime.Text == "")
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Please select Out Time');ShowPopup3();", true);
            return;
        }
        ...
        cmd.Parameters.AddWithValue("@Date", DateTime.ParseExact(txtDate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd"));
        cmd.Parameters.AddWithValue("@InTime", txtInTime.Text.ToString());
        cmd.Parameters.AddWithValue("@OutTime", txtOutTime.Text.ToString());
        ...
        if (result == 0)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Date Already exist');$('.modal-backdrop').remove();", true);
        }
        else
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Date Added successfully','success');$('.modal-backdrop').remove();", true);
        }
    ...
    protected void GVDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "modify")
        {
            ...
            ViewState["ID"] = ID;
            ClearDetails();
            txtDate.Text = GVDetails.Rows[RowIndex].Cells[2].Text;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (result == 0)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Entry Already exist');$('.modal-backdrop').remove();", true);
        }
        else
        {
