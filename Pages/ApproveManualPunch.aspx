<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ApproveManualPunch.aspx.cs" Inherits="ApproveManualPunch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" lang="javascript">
        ...
        function ShowPopup1() {
            $('.modal-backdrop').remove();
            $("#myAlertApprove").modal('show');
        }
        function HidePopup1() {
            $('#myAlertApprove').removeClass('show');
            $('body').removeClass('modal-open');
            $('.modal-backdrop').remove();
        }
        function ShowPopup2() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="myAlertApprove" class="modal" style="overflow-y: auto;">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <asp:Button ID="Button1" runat="server" data-dismiss="modal" class="close" type="button" Text="x" />
                            <h5>Continue to approve?</h5>
                        </div>
                        <div class="modal-body text-center">
                            <asp:Button ID="btnYesApprove" runat="server" Text="Yes" CssClass="btn btn-xs btn-success" OnClick="btnYesApprove_Click" />
                            <asp:Button ID="btnNoApprove" runat="server" Text="No" CssClass="btn btn-xs btn-danger" data-dismiss="modal" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row top-space">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-4">
                        <asp:DropDownList ID="ddlPunchStatus" runat="server" AppendDataBoundItems="true" AutoPostBack="True" CssClass="form-control chosen" OnSelectedIndexChanged="btnSearch_Click">
                            ...
                            <asp:ListItem Value="3">To Be Removed</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                                ...
                                <div class="panel-tools">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <asp:LinkButton runat="server" ID="btnApprovePunch" OnClick="btnApprovePunch_Click"><i class="fa fa-plus"></i>&nbsp;Approve Punch</asp:LinkButton>
