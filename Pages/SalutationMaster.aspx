<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SalutationMaster.aspx.cs" Inherits="Pages_SalutationMaster" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SalutationID" HeaderText="SalutationID" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtSalutation" runat="server" placeholder="Enter Salutation" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
