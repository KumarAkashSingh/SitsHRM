<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DesignationMasterSD.aspx.cs" Inherits="Pages_DesignationMasterSD" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found" OnRowCommand="GVDetails_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DesignationRemarks" HeaderText="Remarks" />
                                            <asp:BoundField DataField="DesignationTypeCode" HeaderText="DesignationTypeCode" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                            ...
                                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlbtnModify" runat="server" CommandName="modify">
                                                        <i class="fa fa-pencil fa-1x" style="color:darkblue;" title="Modify Designation"></i>
                                                    </asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:LinkButton ID="lnlbtnDelete" runat="server" CommandName="del">
                                                        <i class="fa fa-trash fa-1x" style="color:red;" title="Delete Designation"></i>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    <asp:Button ID="btnYes" runat="server" Text="Yes" CssClass="btn btn-success btn-sm" OnClick="btnYes_Click" />
                                    <asp:Button ID="btnNo" runat="server" Text="No" CssClass="btn btn-danger btn-sm" OnClick="btnNo_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlDesignationType" runat="server" AppendDataBoundItems="true" CssClass="chosen form-control">
                                                        <asp:ListItem Value="0" Selected="True">Select Designation Type</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtPreference" runat="server" TextMode="Number" placeholder="Enter Preference" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
