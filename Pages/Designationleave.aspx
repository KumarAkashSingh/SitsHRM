<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Designationleave.aspx.cs" Inherits="Pages_Designationleave" %>
                                ...
                                <div class="panel-body nopadding">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found" OnRowCommand="GVDetails_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="HalfFull" HeaderText="Leave Type" />
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlbtnDelete" runat="server" CommandName="del">
                                                        <i class="fa fa-trash fa-1x" style="color:red;" title="Delete Department Type"></i>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlleaveDescription" runat="server" AppendDataBoundItems="true" CssClass="chosen form-control">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlLeaveCategory" runat="server" AppendDataBoundItems="true" CssClass="chosen form-control">
                                                    <asp:ListItem Value="0" Selected="True">Select Type</asp:ListItem>
                                                    <asp:ListItem Value="Full Day">Full Day</asp:ListItem>
                                                    <asp:ListItem Value="I Half">I Half</asp:ListItem>
                                                    <asp:ListItem Value="II Half">II Half</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
