...
public partial class PartiallyRemoveManualPunch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            GVDetails.DataBind();
            Form.DefaultButton = LinkButton1.UniqueID; 
        }
    }
    ...
    protected DataTable FillGrid()
    {
        ...
        if (txtSearch.Text!="")
        {
            Criteria += " and EM.EmployeeName like '%"+txtSearch.Text+"%'";
        }
    ...
    protected void btnYesRemove_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "ShowPopup();", true);
            dlglbl.Text = "Record(s) sent for Deletion";
        }
