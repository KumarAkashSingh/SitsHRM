<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddDailyTask.aspx.cs" Inherits="AddDailyTask" %>
    ...
    <div id="content">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                            ...
                            <div class="hpanel hpanel-blue2">
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        AutoGenerateColumns="false" EmptyDataText="No Record Found" OnRowCommand="GVDetails_RowCommand" PageSize="50" OnRowDataBound="GVDetails_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="TaskID" HeaderText="TaskID" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                            <asp:BoundField DataField="TaskName" HeaderText="Task Name" />
                                            <asp:BoundField DataField="DOU" HeaderText="Task Date" />
                                            <asp:BoundField DataField="AddTaskRemark" HeaderText="Task Rmark" />
                                            <asp:BoundField DataField="FilesCount" HeaderText="FilesCount" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlViewFiles" runat="server" CommandName="view">
                                                        <i class="fa fa-eye fa-1x" style="color:darkblue;" title="View Files"></i>
                                                    </asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:LinkButton ID="lnlbtnModify" runat="server" CommandName="modify">
                                                        <i class="fa fa-pencil fa-1x" style="color:darkblue;" title="Modify Task"></i>
                                                    </asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:LinkButton ID="lnlbtnDelete" runat="server" CommandName="del">
                                                        <i class="fa fa-trash fa-1x" style="color:red;" title="Delete Task"></i>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                ...
                <div id="addphotos" class="modal" style="overflow-y: auto">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <asp:Button ID="btnClosePhoto1" runat="server" OnClick="btnClosePhoto_Click1" data-dismiss="modal" class="close" type="button" Text="x" />
                                <h5>Show Photos</h5>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 col-sm-12">
                                        <div class="hpanel hpanel-blue2">
                                            <div class="panel-heading">
                                                <h5>All Photos</h5>
                                                <div class="panel-tools">
                                                    <asp:Label ID="lblPhotosCount" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="panel-body nopadding pre-scrollable">
                                                <asp:GridView PagerStyle-CssClass="cssPager" ID="GVPhoto" runat="server" CssClass="table table-bordered table-striped"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblViewImage" Text='<%#Bind("Photo") %>'></asp:Label>&nbsp;View
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                ...
                <div id="maindialog" class="modal" style="overflow-y: auto;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label class="control-label">Daily Task Name</label>
                                            <asp:TextBox ID="txtTaskName" runat="server" placeholder="Enter Task Name" CssClass="form-control" autocomplete="off"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label class="control-label">Date</label>
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="datepicker form-control" autocomplete="off"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-4 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <asp:FileUpload runat="server" ID="fileupload" CssClass="inputfile" AllowMultiple="true" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-6 col-sm-6 col-12 text-right">
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-success btn-xs" OnClick="btnView_Click" Visible="false" />
                                        </div>
                                    </div>
                                </div>
