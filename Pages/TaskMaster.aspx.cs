...
public partial class TaskMaster : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        if (txtTaskName.Text == "")
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Please Add Task Name');ShowPopup3();", true);
            return;
        }
        ...
        if (result == 0)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Task Already exist');ShowPopup3();", true);
            txtTaskName.Text = "";
            return;
        }
        else
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Popup", "$.notify('Task Added successfully','success');$('.modal-backdrop').remove();", true);
        }
