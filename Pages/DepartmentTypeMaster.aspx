<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepartmentTypeMaster.aspx.cs" Inherits="Pages_DepartmentTypeMaster" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DepartmentTypeCode" HeaderText="DepartmentTypeCode" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDepartmentType" runat="server" placeholder="Enter Department Type" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
