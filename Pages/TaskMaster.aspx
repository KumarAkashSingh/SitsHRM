<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskMaster.aspx.cs" Inherits="TaskMaster" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtTaskName" runat="server" placeholder="Enter Task Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
