<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HolidayMaster.aspx.cs" Inherits="Pages_HolidayMaster" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" EmptyDataText="No Record Found" OnRowCommand="GVDetails_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="holidaycode" HeaderText="holidaycode" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtHolidayName" runat="server" placeholder="Enter Holiday Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-6 col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label">Alias Name</label>
                                            <asp:TextBox ID="txtAliasName" runat="server" placeholder="Enter Alias Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
