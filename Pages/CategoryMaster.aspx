                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CategoryID" HeaderText="CategoryID" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtCategoryName" runat="server" placeholder="Enter Category Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
