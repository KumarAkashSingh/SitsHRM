<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HolidayDeclaration.aspx.cs" Inherits="Pages_HolidayDeclaration" %>
                            ...
                            <div class="modal-body">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDate" runat="server" placeholder="Enter Date" CssClass="datepicker form-control" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">In Time</label>
                                        <asp:TextBox ID="txtInTime" runat="server" placeholder="Enter In Time"  CssClass="form-control timepicker" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Out Time</label>
                                        <asp:TextBox ID="txtOutTime" runat="server" placeholder="Enter Out Time"  CssClass="form-control timepicker" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
