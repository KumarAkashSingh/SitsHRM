<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RemoveLeaveDetails.aspx.cs" Inherits="RemoveLeaveDetails" %>
                            ...
                            <div class="hpanel hpanel-blue2">
                                ...
                                <div class="panel-body table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVLeaveDetails" 
                                        ...
                                        OnRowCommand="GVLeaveDetails_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlbtnCancel" runat="server" CommandName="can">
                                                        <i class="fa fa-times fa-1x" style="color:darkblue;" title="Cancel Leave"></i>
                                                    </asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
