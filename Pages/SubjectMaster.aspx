<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubjectMaster.aspx.cs" Inherits="SubjectMaster" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtSubjectName" runat="server" placeholder="Enter Subject Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
