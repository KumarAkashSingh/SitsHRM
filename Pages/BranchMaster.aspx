<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BranchMaster.aspx.cs" Inherits="Pages_BranchMaster" %>
                                ...
                                <div class="panel-body nopadding table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server" CssClass="table table-bordered table-striped"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="BranchID" HeaderText="BranchID" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtBranch" runat="server" placeholder="Enter Branch Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
