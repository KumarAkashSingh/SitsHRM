<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ApproveWithdrawlLeaveSDNew.aspx.cs" Inherits="Forms_ApproveWithdrawlLeaveSDNew" %>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlAction" runat="server" CssClass="select2 form-control">
                                    ...
                                    <asp:ListItem Value="1">Withdrawl Accepted</asp:ListItem>
                                    <asp:ListItem Value="2">Withdrawl Rejected</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                                ...
                                <div class="panel-body table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVApprovedLeaveDetails" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False"  PageSize="20" CaptionAlign="Right" OnRowCommand="GVApprovedLeaveDetails_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Both" OnRowDataBound="GVApprovedLeaveDetails_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="App. Date" HeaderText="APP Date" />
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlDate" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen" OnSelectedIndexChanged="ddlDate_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlCourse" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlSubject" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen" OnSelectedIndexChanged="ddlSubject_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlPeriod" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen" OnSelectedIndexChanged="ddlPeriod_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlBatch" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlEFaculty" runat="server" AppendDataBoundItems="true" CssClass="form-control chosen" OnSelectedIndexChanged="ddlEFaculty_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-success btn-xs" OnClick="btnUpdate_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
