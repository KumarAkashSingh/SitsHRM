<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="View_Payroll_SetSalary.aspx.cs" Inherits="View_Payroll_SetSalary" %>
                        ...
                        <div class="col-md-4 col-xs-6 col-sm-4">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <asp:LinkButton runat="server" ID="btnSearch" CssClass="btn btn-info btn-sm">
                                ...
                                <div class="panel-body table-responsive">
                                    <asp:GridView PagerStyle-CssClass="cssPager" ID="GVDetails" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="View Salary" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlbtnUpdate" runat="server" CommandName="UpdateSalary"><i class="fa fa-eye fa-1x" style="color:darkgreen;" title="Update Salary"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                ...
                <div id="myAlert6" class="modal" style="overflow-y: auto">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                                                ...
                                                <asp:GridView PagerStyle-CssClass="cssPager" ID="GVSalaryUpdate" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" EmptyDataText="No Record Found" OnRowDataBound="GVSalaryUpdate_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Amount">
                                                            <ItemTemplate>
                                                                <asp:Label ID="txtAmount" runat="server" Text='<%# Bind("Amount") %>' Width="100px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                            ...
                            <%--<div class="modal-footer">
                                <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-xs btn-success" OnClick="btnUpdate_Click" />
                                <asp:Button ID="btnClose1" runat="server" Text="Close" OnClick="btnClose1_Click" CssClass="btn btn-xs btn-success" />
                            </div>--%>
                        </div>
                    </div>
                </div>
